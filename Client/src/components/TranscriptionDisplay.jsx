...
const TranscriptionDisplay = ({ transcription, isProcessing, onClear }) => {
  const handleCopy = () => {
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-white/[0.06]">
        ...
        <div className="flex items-center gap-2">
          ...
          {transcription && onClear && (
            <button
              onClick={onClear}
              className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-red-400 hover:text-red-300 hover:bg-red-500/10 rounded-lg transition-all duration-200"
            >
              <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
